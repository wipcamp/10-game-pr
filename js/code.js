...
function arrowDeploy() {
	...
	arrow.body.velocity.x = -speedobj + 200;
}
...
function create() {
	...
	text = game.add.text(150, 5, '', { font: "70px Number", fill: "#1b1a1a", align: "center" });
...
function update() {
	...
	this.palacer.tilePosition.x -= 2.5 + speed
	this.wallr.tilePosition.x -= 2.5 + speed
	this.floorback.tilePosition.x -= 2.5 + speed
...
function update2() {
	...
	this.mountain.tilePosition.x -= 3 + speed
	this.busht.tilePosition.x -= 2 + speed
	this.palacet.tilePosition.x -= 2.5 + speed
	this.wallt.tilePosition.x -= 2.5 + speed
	this.floorback.tilePosition.x -= 2.5 + speed
...
function createGameOver() {
	...
	scoretext = game.add.text(500, 210, '' + score, { font: "50px Number", fill: "#FFFFFF", align: "center" });
...
function start() {
    ...
    game.time.events.add(2000, changeSource, this);
